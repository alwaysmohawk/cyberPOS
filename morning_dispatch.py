...
FOOTERS = [
    "RISE. MOVE. CONQUER.",
    "NEW DAY. FRESH START. GO.",
    "THE MORNING SETS THE TONE.",
    "START STRONG. EVERYTHING FOLLOWS.",
    "YOU KNOW WHAT TO DO. START NOW.",
    "SMALL HABITS BUILD BIG LIVES.",
    "ONE STEP. THEN THE NEXT.",
    "MORNING IS YOUR SUPERPOWER.",
]
